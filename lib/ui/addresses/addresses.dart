...
class _MyAddressesState extends State<MyAddresses> {
  ...
  void loadData() async {
    ...
    await addressesProvider.getAddresses();
  }
                  ...
                  addressesProvider.allAddressesDataList.isEmpty
                      ...
                      : Expanded(
                          child: Showcase(
                            key: listAddressKey,
                            description:
                                S.of(context).swipeAnyAddressLeftToDelete,
                            child: Padding(
                              ...
                              child: ShowCaseWidget(
                                ...
                                return ListView.separated(
                                  ...
                                  itemCount: addressesProvider
                                          .allAddressesDataList.length +
                                      1,
                                  itemBuilder: (context, index) {
                                    if (index <
                                                    ...
                                                    addressesProvider
                                                        ...
                                                        ? addressesProvider
                                                            .allAddressesDataList[
                                                                index]
                                                            .image!
                                                        : 'https://cdn.salla.sa/OnAOY/tD8aFkV8PRKh2ryXbFwigSEa7DAlKISoYXwwE11s.png',
                                                    fit: BoxFit.cover,
                                                  ),
                                                ),
                                                horizontalSpace(12),
                                                Expanded(
                                                  child: CustomSizedBox(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        TextWidget(
                                                          text: addressesProvider.allAddressesDataList[index].locationName == 'Location Name' ||
                                                                  addressesProvider
                                                                          .allAddressesDataList[
                                                                              index]
                                                                          .locationName ==
                                      ...
                                      return addressesProvider.currentPage >=
                                              addressesProvider.lastPage
                                          ? SizedBox()
                                          : Padding(
                                              padding: symmetricEdgeInsets(
                                                  horizontal: 50),
