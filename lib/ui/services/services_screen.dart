                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: ListView.separated(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    actions: [
                                      Padding(
                                        padding:
                                            symmetricEdgeInsets(vertical: 5),
                                        child: Row(
                                          mainAxisAlignment:
                          ...
                          separatorBuilder: (context, index) =>
                              verticalSpace(14),
                          itemCount:
                              requestServicesProvider.basicServicesList.length,
                        ),
                      ),
                    ),
                    verticalSpace(40),
                    ...
                    CustomContainer(
                      ...
                      child: Padding(
                        padding:
                            symmetricEdgeInsets(vertical: 24, horizontal: 24),
                        child: Column(
                          children: [
                            Row(
                              children: [
                            ...
                            Row(
                              children: [
                                ...
                                CustomContainer(
                                  ...
                                  child: Center(
                                    child: DefaultFormField(
                                      ...
                                      hintText: '',
                                      enabled:
                                          requestServicesProvider.couponData ==
                                              null,
                                ...
                                TextButton(
                                  onPressed:
                                      requestServicesProvider.couponData != null
                                          ? () {
                                              requestServicesProvider
                                                  .resetCoupon();
                                            }
                                  ...
                                  child: TextWidget(
                                    text: requestServicesProvider.couponData !=
                                            null
                                        ? S.of(context).remove
                                        : S.of(context).apply,
                                    textSize: MyFontSize.size12,
                                    fontWeight: MyFontWeight.medium,
                                    color: requestServicesProvider.couponData !=
                                            null
                                        ? AppColor.textRed
                                        : AppColor.primary,
                                  ),
